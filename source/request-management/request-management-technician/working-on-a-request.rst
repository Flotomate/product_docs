...
-  Section-C also houses the :ref:`Search KnowledgeBase <linking knowledge with a request>` feature.
...
-  Section-E is :ref:`Task <rm-managing-task>` column which is a sub-feature of the Work tab.
...
- A window pane will open where you can access the following information.
    ...
    a. Other requests created by the requester.
    b. Profile of the requester.
    c. Assets assigned to the requester. 
    ...
    .. figure:: https://s3-ap-southeast-1.amazonaws.com/flotomate-resources/request-management/RM-18.1.png
        ...
        Requester details. :ref:`Learn more <Searching and Viewing Requester Details>`.
  ...
  .. note:: In the user Profile tab (:numref:`rmf-18.2`), you can also view the values of :ref:`Custom User Fields <User Custom Field>`.
