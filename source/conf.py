...
htmlhelp_basename = 'ITSMProductDocumentationdoc'
...
man_pages = [
    (master_doc, 'itsmproductdocumentation', u'ITSM Product Documentation Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ITSMProductDocumentation', u'ITSM Product Documentation Documentation',
     author, 'ITSMProductDocumentation', 'One line description of project.',
     'Miscellaneous'),
]
